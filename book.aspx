<%@ Page Title="" Language="C#" MasterPageFile="~/HTML/Site1.Master" AutoEventWireup="true" CodeBehind="book.aspx.cs" Inherits="demo2.HTML.book" %>
                                        ...
                                        <table style="width: 100%; border=1">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td>
                                                               <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="Submit" OnClick="Button2_Click" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </table>
                                        <div class="clearfix"></div>
