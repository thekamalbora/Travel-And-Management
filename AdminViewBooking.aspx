...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="bookingid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="100%">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="travelername" HeaderText="Traveler Name" SortExpression="travelername">
            <ItemStyle HorizontalAlign="Left" />
            </asp:BoundField>
